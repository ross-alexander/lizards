...
#define PLAYER_VOID 0
#define PLAYER_ACTIVE 1
#define PLAYER_WITHDREW 2
#define PLAYER_EXTINCT 3
...
extern char* liz_dir[7];
extern char* liz_colours[6];
...
extern void player_mesg(world_t *w, int p, char *s, ...);
...
extern void new_show_order(world_t *w, order_t *order);
...
extern feature_t* pop_feature(world_t *w, hex_t *hex);
...
extern void show_order (world_t *w, order_t *order);
...
extern void open_player_mesg(world_t *, int, FILE**);
#endif
