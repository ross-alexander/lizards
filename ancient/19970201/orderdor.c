...
int main (int argc, char **argv)
{
  ...
  {
    printf ("FATAL ERROR: Invalid player number for game. Press SPACE.\n");
      ...
      &field_in, check_order_format, order_ditto, order_skip_to_field))
    {
      case ERASE_KEY:
        ...
        if (option == 'Y')
        {
          ...
          set_field (order_template, player_orders [selected_player], 5, player_clan_name [selected_player]);
          set_field (order_template, player_orders [selected_player], 6, player_code [selected_player]);
        }
