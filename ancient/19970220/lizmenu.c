...
void change_player (void)
{
  ...
  set_field (player_template, player_data, 2, player[player].clan_name);
  set_field (player_template, player_data, 3, player[player].code);
  ...
  {
    if (player_data [2] != '\0')
      strcpy (player[player].clan_name, player_data [2]);
    else
      player[player].clan_name[0] = '\0';

    if (player_data [3] != '\0')
      strcpy (player[player].code, player_data [3]);
    else
      player[player].code[0] = '\0';
