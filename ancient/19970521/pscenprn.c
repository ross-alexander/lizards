...
void ps_show_hex (World *, int x, int y, int player, FILE *fptr);
int spy_at (World*, int x, int y, int player);
...
void ps_show_hex (World *world, int x, int y, int player, FILE *fptr)
{
  char string [80];
...
int spy_at (World *world, int x, int y, int player)
{
  int work;
